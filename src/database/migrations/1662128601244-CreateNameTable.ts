...
//         await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "slug" character varying NOT NULL, "logoId" uuid, "statusId" integer, CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TABLE "tier_model" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "statusId" integer, CONSTRAINT "PK_f77960fd789d2b9a4f95db87050" PRIMARY KEY ("id"))`);
...
//         await queryRunner.query(`CREATE TABLE "file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "path" character varying NOT NULL, "productId" uuid, CONSTRAINT "PK_36b46d232307066b3a2c9ea3a1d" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TABLE "banner" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "type" integer NOT NULL, "link" character varying, "order" integer NOT NULL DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "photoId" uuid, "statusId" integer, CONSTRAINT "PK_6d9e2570b3d85ba37b681cd4256" PRIMARY KEY ("id"))`);
...
//         await queryRunner.query(`ALTER TABLE "categories" ADD CONSTRAINT "FK_3f43543ba2a8716cc5d3dd58ae8" FOREIGN KEY ("logoId") REFERENCES "file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
//         await queryRunner.query(`ALTER TABLE "tier_model" ADD CONSTRAINT "FK_3386c1c0dba4b5faaf69ea648c3" FOREIGN KEY ("statusId") REFERENCES "status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
//         await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_9ec2c7792817b56a3533ca1d7aa" FOREIGN KEY ("statusId") REFERENCES "status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
//         await queryRunner.query(`ALTER TABLE "banner" ADD CONSTRAINT "FK_069dddfdc9b2255d633a27e3b17" FOREIGN KEY ("photoId") REFERENCES "file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
//         await queryRunner.query(`ALTER TABLE "banner" ADD CONSTRAINT "FK_b8cbc3e8c3efd6dca51ab58ee40" FOREIGN KEY ("statusId") REFERENCES "status"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
//         await queryRunner.query(`ALTER TABLE "banner" DROP CONSTRAINT "FK_b8cbc3e8c3efd6dca51ab58ee40"`);
//         await queryRunner.query(`ALTER TABLE "banner" DROP CONSTRAINT "FK_069dddfdc9b2255d633a27e3b17"`);
...
//         await queryRunner.query(`ALTER TABLE "product" DROP CONSTRAINT "FK_9ec2c7792817b56a3533ca1d7aa"`);
//         await queryRunner.query(`ALTER TABLE "tier_model" DROP CONSTRAINT "FK_3386c1c0dba4b5faaf69ea648c3"`);
