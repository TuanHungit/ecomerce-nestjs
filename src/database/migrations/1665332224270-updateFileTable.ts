...
export class updateFileTable1665332224270 implements MigrationInterface {
    name = 'updateFileTable1665332224270'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "file" ADD "type" integer`);
        await queryRunner.query(`ALTER TABLE "file" ADD "duration" character varying`);
