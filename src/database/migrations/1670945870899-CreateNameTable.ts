...
export class CreateNameTable1670945870899 implements MigrationInterface {
  name = 'CreateNameTable1670945870899';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "cart" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "products" jsonb NOT NULL, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
