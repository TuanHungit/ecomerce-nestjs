...
export class CreateNameTable1671464468062 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "banner" ADD "userId" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "banner" ADD "fullName" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "banner" ADD "phoneNumber" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "banner" ADD "address" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "banner" ADD "isDefault" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "banner" ADD "title" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "banner" ADD "type" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "banner" ADD "link" character varying`);
        await queryRunner.query(`ALTER TABLE "banner" ADD "order" integer NOT NULL DEFAULT '1'`);
