...
export class CreateNameTable51671204120526 implements MigrationInterface {
  name = 'CreateNameTable51671204120526';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "product" ADD "params" jsonb`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "product" DROP COLUMN "params"`);
    await queryRunner.query(
      `ALTER TABLE "order_products" DROP COLUMN "discount"`,
    );
    await queryRunner.query(
