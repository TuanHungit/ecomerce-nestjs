...
export class CreateNameTable61671353026945 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "amount"`);
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "amountBeforeDiscount"`);
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "quantity"`);
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "discount"`);
        await queryRunner.query(`ALTER TABLE "model" ADD "parent" character varying`);
        await queryRunner.query(`ALTER TABLE "order_products" ADD "amount" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "order_products" ADD "amountBeforeDiscount" integer`);
        await queryRunner.query(`ALTER TABLE "order_products" ADD "quantity" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "order_products" ADD "discount" integer`);
        await queryRunner.query(`ALTER TABLE "order_products" ALTER COLUMN "orderId" DROP DEFAULT`);
        await queryRunner.query(`DROP SEQUENCE "order_products_orderId_seq"`);
        await queryRunner.query(`ALTER TABLE "order_products" ALTER COLUMN "productId" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "order_products" ADD CONSTRAINT "FK_28b66449cf7cd76444378ad4e92" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "order_products" ADD CONSTRAINT "FK_27ca18f2453639a1cafb7404ece" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_207eadbaa38ce8cf4625642519"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5198460192ebbd084ffbb5aebd"`);
        await queryRunner.query(`CREATE SEQUENCE IF NOT EXISTS "order_products_productId_seq" OWNED BY "order_products"."productId"`);
        await queryRunner.query(`ALTER TABLE "order_products" ALTER COLUMN "productId" SET DEFAULT nextval('"order_products_productId_seq"')`);
        await queryRunner.query(`CREATE SEQUENCE IF NOT EXISTS "order_products_orderId_seq" OWNED BY "order_products"."orderId"`);
        await queryRunner.query(`ALTER TABLE "order_products" ALTER COLUMN "orderId" SET DEFAULT nextval('"order_products_orderId_seq"')`);
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "discount"`);
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "quantity"`);
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "amountBeforeDiscount"`);
        await queryRunner.query(`ALTER TABLE "order_products" DROP COLUMN "amount"`);
