...
export class CreateNameTable61671206524780 implements MigrationInterface {
  name = 'CreateNameTable61671206524780';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ALTER COLUMN "params" SET DEFAULT '{}'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ALTER COLUMN "params" DROP DEFAULT`,
    );
    await queryRunner.query(
