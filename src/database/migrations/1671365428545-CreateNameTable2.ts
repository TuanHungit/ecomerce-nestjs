...
export class CreateNameTable21671365428545 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "path" character varying NOT NULL, "type" character varying, "duration" integer, CONSTRAINT "PK_36b46d232307066b3a2c9ea3a1d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "categories" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "slug" character varying, "logoId" uuid, "statusId" integer, CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "brand" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "totalProduct" integer NOT NULL DEFAULT '0', "slug" character varying, "logoId" uuid, "imageId" uuid, "statusId" integer, CONSTRAINT "REL_062524ac7f03786e461134ea62" UNIQUE ("imageId"), CONSTRAINT "PK_a5d20765ddd942eb5de4eee2d7f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cart" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "product" jsonb NOT NULL, CONSTRAINT "PK_c524ec48751b9b5bcfbf6e59be7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order_products" ("id" SERIAL NOT NULL, "orderId" integer NOT NULL, "productId" integer NOT NULL, "price" integer NOT NULL, "priceBeforeDiscount" integer, "quantity" integer NOT NULL, "discount" integer, CONSTRAINT "PK_3e59f094c2dc3310d585216a813" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('unpaid', 'pending', 'aborted', 'successful')`);
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "totalAmount" integer NOT NULL, "totalAmountBeforeDiscount" integer, "userId" character varying NOT NULL, "status" "public"."orders_status_enum" NOT NULL DEFAULT 'unpaid', "note" character varying NOT NULL, "address" character varying, "paymentMethod" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "likedCount" integer NOT NULL DEFAULT '0', "discount" integer NOT NULL, "stock" integer NOT NULL DEFAULT '0', "price" integer NOT NULL, "priceBeforeDiscount" integer NOT NULL, "sold" integer NOT NULL DEFAULT '0', "keywords" jsonb, "params" jsonb DEFAULT '{}', "slug" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "imageId" uuid, "statusId" integer, "categoriesId" integer, "brandId" integer, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
