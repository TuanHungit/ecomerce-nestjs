...
export class updateBrand91662825970303 implements MigrationInterface {
  name = 'updateBrand91662825970303';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "brands_categories" ("brandId" integer NOT NULL, "categoriesId" uuid NOT NULL, CONSTRAINT "PK_b48fcd532fd89479dc81cd6e141" PRIMARY KEY ("brandId", "categoriesId"))`,
    );
    await queryRunner.query(
